...
/** 落款金句池：32 条 × 4 组（镜/路/缘/时），同一天稳定不变（pickBySeed 按日期取） */
...
export const YI_JI = {
  '木': [
    { yi: ['生长', '抽枝', '开卷'], ji: ['壅塞', '呆坐', '恋栈'] },
    { yi: ['栽种', '晨读', '舒展'], ji: ['伐木', '折枝', '僵直'] },
    { yi: ['生发', '早起', '远行'], ji: ['压顶', '枯坐', '拖延'] },
  ],
  '火': [
    { yi: ['明动', '举火', '发端'], ji: ['虚浮', '焦躁', '燎原'] },
    { yi: ['会友', '开张', '亮话'], ji: ['泼水', '怒发', '上头'] },
    { yi: ['聚气', '起势', '表意'], ji: ['冒烟', '闷烧', '亢奋'] },
  ],
  '土': [
    { yi: ['承载', '培土', '安顿'], ji: ['停滞', '拖沓', '僵局'] },
    { yi: ['归位', '收纳', '深耕'], ji: ['飘摇', '打转', '内耗'] },
    { yi: ['结庐', '守成', '踏实'], ji: ['塌方', '空转', '垫底'] },
  ],
  '金': [
    { yi: ['收敛', '裁断', '收成'], ji: ['刚愎', '割裂', '锋锐'] },
    { yi: ['清账', '了结', '亮剑'], ji: ['对峙', '锈蚀', '多虑'] },
    { yi: ['交割', '定音', '打磨'], ji: ['撕扯', '悬置', '较劲'] },
  ],
  '水': [
    { yi: ['流动', '归源', '润物'], ji: ['泛滥', '沉溺', '决堤'] },
    { yi: ['出行', '交心', '静观'], ji: ['逆行', '漩涡', '失锚'] },
    { yi: ['涤尘', '顺势', '潜行'], ji: ['漫灌', '内涝', '漂浮'] },
  ],
  '天': [
    { yi: ['定志', '顺势', '观时'], ji: ['游移', '逆势', '妄动'] },
    { yi: ['借势', '立信', '择机'], ji: ['强求', '盲从', '躁进'] },
    { yi: ['观局', '布局', '待时'], ji: ['失机', '空谈', '操之过急'] },
  ],
  '人': [
    { yi: ['和合', '守信', '自省'], ji: ['独断', '失信', '逐利'] },
    { yi: ['倾听', '言诺', '照拂'], ji: ['猜忌', '敷衍', '计较'] },
    { yi: ['同行', '让渡', '念旧'], ji: ['相轻', '牵绊', '讨好'] },
  ],
};
