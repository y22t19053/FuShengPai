...
export function getPeriodLabel(periodType) {
  return PERIODS[periodType]?.label || '';
}

export function getPeriodTitle(periodType) {
  return PERIODS[periodType]?.title || '';
}

export function getPeriodDesc(periodType) {
  return PERIODS[periodType]?.desc || '';
}
